  ...
  <v-container grid-list-md text-xs-center mt-2>
    <v-layout row wrap>
      <v-flex xs12 sm6>
        ...
        <h3 class="display-1 product-title mt-3">ISLAND Earthworks <span class="blue--text text--darken-2">Server</span></h3>
      ...
      <v-flex xs12 sm6>
        ...
        <h3  class="display-1 product-title mt-3">ISLAND Earthworks <span class="blue--text text--darken-2">Desktop</span></h3>
